# CLAUDE.md — 데이터 지식 스튜디오

> Claude Code가 이 폴더에서 작업할 때 참조하는 프로젝트 컨텍스트
> 완료 이력 상세: `CLAUDE-달성상태-아카이브.md`
> 파일 경로 바로가기: `CLAUDE-참조-인덱스.md`
...
- 상위 CLAUDE.md의 Obsidian 응답 형식 준수 (YAML 프론트매터, [[키워드]] 링크)
- 제안서/보고서는 개조식 문법 적용
- 설비 종류 첫 등장 시 [[링크]] 필수
